<div>
    <footer class="border-t border-gray-200 bg-gray-800">
        <div
            class="
        container
      ...
      ">
          ...
          ">
            ...
            <div class="flex justify-center mt-4 lg:mt-2">
                ...
                <a class="ml-3" href="http://twitter.com" target="_blank">
                    <svg fill="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                ...
                <a class="ml-3" href="http://instagram.com" target="_blank">
                ...
                <a class="ml-3" href="http://linkedin.com" target="_blank">
...
<div class="flex justify-center -mt-12 bg-gray-800">
