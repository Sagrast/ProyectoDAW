<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8 py-8">
        <form class="w-full max-w-lg mx-auto " method="POST" action="{{ route('web.vehicles.update', $vehicle->id) }}">
            @csrf
            <div class="flex flex-wrap -mx-3 mb-6">
                <div class="w-full md:w-1/2 px-3 mb-6 md:mb-0">
                    ...
                    <input value="{{ $vehicle->descripcion }}"
                ...
                <div class="w-full md:w-1/2 px-3">
                    ...
                    <input value="{{ $vehicle->kilometros }} "
                ...
                <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full px-3">
                        <label class="block uppercase tracking-wide text-gray-700 text-xs font-bold mb-2" for="itv"
                            value="{{ $vehicle->itv }}">
                            ITV
                        </label>
                        <input
